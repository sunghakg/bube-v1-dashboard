...
**2026-05-24 통합**: 기존 두 봇(YB MDD OR + Rotation P5.5) → bube_trader.py (Tier 2 GOLD_ESCAPE bm=90) 하나로 통합.
...
7. **💰 BUBE Live** — Alpaca paper 실잔고 + 실시간 regime 판정 + active sub-strategy 표시
...
| Key | Value |
|---|---|
| `ALPACA_API_KEY` | 신규 BUBE paper key (PK로 시작) |
